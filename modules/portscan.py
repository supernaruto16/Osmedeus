...
class PortScan(skeleton.Skeleton):
    ...
    def clean_gowitness(self, command):
        ...
        real_cmd = utils.resolve_command(self.options, {
            ...
            "cmd": "gowitness report generate -n $WORKSPACE/portscan/screenshot/$OUTPUT-raw-gowitness.html --destination $WORKSPACE/portscan/screenshot/raw-gowitness/ --db $WORKSPACE/portscan/screenshot/gowitness.db",
