...
class VulnScan(skeleton.Skeleton):
    ...
    def clean_gowitness(self, command):
        ...
        command = utils.resolve_command(self.options, {
            ...
            "cmd": "gowitness report generate -n $WORKSPACE/vulnscan/screenshot/$OUTPUT-raw-gowitness.html --destination $WORKSPACE/vulnscan/screenshot/raw-gowitness/ --db $WORKSPACE/vulnscan/screenshot/gowitness.db",
